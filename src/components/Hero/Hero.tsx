    ...
    return (
        <div className="bg-gray-50 grid grid-cols-1 lg:grid-cols-7 items-center gap-8 p-8">
            ...
            <div className="lg:col-span-3 w-11/12 mx-auto ">
                ...
                {heroFeats.map(({ image, title, description },index) => (
                    <div key={index} className="grid grid-cols-12 shadow-inner items-center px-6 py-2 bg-white rounded-lg mt-4 mb-10">
